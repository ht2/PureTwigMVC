...
require_once PUREMVC.'interfaces/INotifier.php'; 
require_once PUREMVC.'patterns/observer/Notifier.php'; 
...
class Proxy extends Notifier implements IProxy, INotifier
{
  ...
  public function fieldArrayFromObjects($objects, $field) {
      $results = array();
      if(empty($objects)) {
          return false;
      }
