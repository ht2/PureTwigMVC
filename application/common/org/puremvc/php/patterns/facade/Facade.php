...
require_once PUREMVC.'core/Controller.php';
require_once PUREMVC.'core/Model.php';
require_once PUREMVC.'core/View.php';
require_once PUREMVC.'interfaces/IFacade.php';
...
require_once PUREMVC.'patterns/observer/Notification.php';
